...
// cpp keys social edges by the real SUB (not email) and /ui/social/follow 404s
// unless the target has a tlc_profile row; resolve to the live SUB under cpp
// (byte-identical email on the Python path). Session lookups use *_KEY only.
