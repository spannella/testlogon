...
const MORE_LINKS = [
  ...
  { label: "Licenses", i18nKey: "nav.licenses", path: "/licenses", icon: FileCheck },
  { label: "Bots", i18nKey: "nav.bots", path: "/bots", icon: Bot },
  { label: "Licenses Issued", i18nKey: "nav.licensesIssued", path: "/licenses/issued", icon: Scale },
  { label: "Licenses Held", i18nKey: "nav.licensesHeld", path: "/licenses/held", icon: Scale },
  { label: "Licensed Library", i18nKey: "nav.licensedLibrary", path: "/licenses/library", icon: Scale },
  ...
  { label: "Earnings", i18nKey: "nav.earnings", path: "/earnings", icon: DollarSign },
