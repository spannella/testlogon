...
export function adaptMessage(raw: RawMessage): Message {
  return {
    ...
    thread_root_message_id: raw.thread_root_message_id,
    has_thread: raw.has_thread,
    thread_reply_count: raw.thread_reply_count,
    thread_last_reply_at: raw.thread_last_reply_at,
    ...
    countdown_title: raw.countdown_title,
    ...
    gif_width: raw.gif_width,
    gif_height: raw.gif_height,
    gif_provider: raw.gif_provider,
    sticker_id: raw.sticker_id,
    sticker_collection_id: raw.sticker_collection_id,
    sticker_url: raw.sticker_url,
    sticker_alt_text: raw.sticker_alt_text,
    lottery: raw.lottery,
