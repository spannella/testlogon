...
**File**: `tests/test_web_push.py`

| # | Test Function | Description |
|---|--------------|-------------|
| 1 | `test_platform_010_create` | Create primary entity; 201 |
| 2 | `test_platform_010_read` | Read back entity; correct fields |
| 3 | `test_platform_010_update` | Update entity; 200; changes reflected |
| 4 | `test_platform_010_delete` | Delete entity; 200/204 |
| 5 | `test_platform_010_auth_required` | No auth; 401 |
| 6 | `test_platform_010_validation` | Invalid input; 422 |
...
**File**: `frontend/e2e/web-push.spec.ts` -- 14 tests
...
| Ticket | Type | Detail |
|--------|------|--------|
| NOTIFY-001 | Optional | Notification bell provides context for push subscription prompt |

### Depended On By

| Ticket | Type | Detail |
|--------|------|--------|
| PLATFORM-016 | Enables | Push delivery engine depends on registered subscriptions |

### Merge Strategy

**Feature-flag-gated** -- WEB_PUSH_ENABLED controls feature. Can merge before NOTIFY-001.
...
- [ ] E2E pass: `npx playwright test e2e/web-push.spec.ts`
