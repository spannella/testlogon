...
**Test file**: `tests/test_broadcast_private.py`

**Mock setup**: moto mock for DynamoDB (broadcast tables). Mock broadcast provider for instant state transitions.

| Test Function | Description |
|---|---|
| `test_create_bcast011_resource` | Create primary resource; verify stored in DDB with correct fields |
| `test_get_bcast011_resource` | Get resource by ID; verify all fields returned |
| `test_list_bcast011_resources` | List resources; verify pagination and filtering |
| `test_update_bcast011_resource` | Update resource; verify changed fields persisted |
| `test_delete_bcast011_resource` | Delete resource; verify removed from DDB |
...
**Test file**: `frontend/e2e/broadcast-private.spec.ts`
...
|---|---|---|---|
| BCAST-005 | Live chat for private session requests | Implemented | Yes |
| CALL-001 to CALL-010 | WebRTC call infrastructure for private video calls | Implemented | Yes |
...
Independent. New DDB table (`BroadcastPrivateSessions`), new service. Bridges broadcast and call systems.
