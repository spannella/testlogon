...
**Test file**: `tests/test_bot_ai_llm.py`
...
**Test file**: `frontend/e2e/bot-ai-llm.spec.ts`
...
|---|---|---|---|
| BOT-001 | Bot framework CRUD and message pipeline | Implemented | No -- must merge after |
...
Sequential after BOT-001. Parallel-safe with BOT-002/003. Adds LLM proxy, conversation history, safety guardrails.
