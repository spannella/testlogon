...
|---|--------------|-------------|
| 1 | `test_shop_003_create` | Create primary entity; 201 |
| 2 | `test_shop_003_read` | Read back entity; correct fields |
| 3 | `test_shop_003_update` | Update entity; 200; changes reflected |
| 4 | `test_shop_003_delete` | Delete entity; 200/204 |
| 5 | `test_shop_003_auth_required` | No auth; 401 |
| 6 | `test_shop_003_validation` | Invalid input; 422 |
...
**File**: `frontend/e2e/cart-abandonment.spec.ts` -- 12 tests
...
| Ticket | Type | Detail |
|--------|------|--------|
| PLATFORM-006 | Optional | Email delivery for abandonment reminders |
...
**Feature-flag-gated** -- CART_ABANDONMENT_ENABLED controls scanner independently.
...
- [ ] E2E pass: `npx playwright test e2e/cart-abandonment.spec.ts`
