...
**File**: `tests/test_push_delivery.py`

| # | Test Function | Description |
|---|--------------|-------------|
| 1 | `test_platform_016_create` | Create primary entity; 201 |
| 2 | `test_platform_016_read` | Read back entity; correct fields |
| 3 | `test_platform_016_update` | Update entity; 200; changes reflected |
| 4 | `test_platform_016_delete` | Delete entity; 200/204 |
| 5 | `test_platform_016_auth_required` | No auth; 401 |
| 6 | `test_platform_016_validation` | Invalid input; 422 |
...
**File**: `frontend/e2e/push-delivery.spec.ts` -- 12 tests
...
| Ticket | Type | Detail |
|--------|------|--------|
| PLATFORM-010 | Required | Push subscriptions must be registered before delivery works |
...
**Sequential** -- Requires PLATFORM-010 merged for push subscription registration.
...
- [ ] E2E pass: `npx playwright test e2e/push-delivery.spec.ts`
