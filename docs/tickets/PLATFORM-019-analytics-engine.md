...
|---|--------------|-------------|
| 1 | `test_platform_019_create` | Create primary entity; 201 |
| 2 | `test_platform_019_read` | Read back entity; correct fields |
| 3 | `test_platform_019_update` | Update entity; 200; changes reflected |
| 4 | `test_platform_019_delete` | Delete entity; 200/204 |
| 5 | `test_platform_019_auth_required` | No auth; 401 |
| 6 | `test_platform_019_validation` | Invalid input; 422 |
...
**File**: `frontend/e2e/analytics.spec.ts` -- 12 tests
...
**Independent** -- New analytics_events table; no conflicts with existing tables.
...
- [ ] E2E pass: `npx playwright test e2e/analytics.spec.ts`
