...
**File**: `tests/test_content_scheduling.py`

| # | Test Function | Description |
|---|--------------|-------------|
| 1 | `test_sched_001_create` | Create primary entity; 201 |
| 2 | `test_sched_001_read` | Read back entity; correct fields |
| 3 | `test_sched_001_update` | Update entity; 200; changes reflected |
| 4 | `test_sched_001_delete` | Delete entity; 200/204 |
| 5 | `test_sched_001_auth_required` | No auth; 401 |
| 6 | `test_sched_001_validation` | Invalid input; 422 |
...
**File**: `frontend/e2e/content-scheduling.spec.ts` -- 15 tests
...
| Ticket | Type | Detail |
|--------|------|--------|
| SHOP-003 | Optional | Cart abandonment can use unified scheduler |

### Merge Strategy

**Independent** -- New scheduled_actions table; unifies existing per-module schedulers.
...
- [ ] E2E pass: `npx playwright test e2e/content-scheduling.spec.ts`
