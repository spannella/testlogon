...
### Unit Tests (`tests/test_custom_emojis.py`)
**Framework**: pytest + moto (DynamoDB/S3 mock)

| # | Test Function | What It Verifies |
|---|--------------|-----------------|
| 1 | `test_upload_personal_emoji` | Upload personal emoji |
| 2 | `test_upload_global_emoji_admin` | Upload global emoji admin |
| 3 | `test_shortcode_uniqueness` | Shortcode uniqueness |
| 4 | `test_image_size_validation` | Image size validation |
| 5 | `test_personal_scope_isolation` | Personal scope isolation |
| 6 | `test_delete_emoji_shows_fallback` | Delete emoji shows fallback |
| 7 | `test_emoji_in_reactions` | Emoji in reactions |
| 8 | `test_category_grouping` | Category grouping |
...
### E2E Tests (`frontend/e2e/custom-emojis.spec.ts`)
...
### CI/Pipeline
- Feature flags: `CUSTOM_EMOJIS_ENABLED=true`
...
|--------|-----------------|-----------|
| MSG-006 | Emoji Messages for EmojiPicker component | Hard |
...
### Merge Strategy
**Sequential -- requires MSG-006 merged first. Custom tab integrates into EmojiPicker from MSG-006.**

### Merge Checklist
- [ ] Feature flags configured in `.env.local`: CUSTOM_EMOJIS_ENABLED=true
- [ ] Service file created/modified: `app/services/custom_emojis.py`
- [ ] No endpoint prefix conflicts with existing routers
- [ ] E2E tests pass: `cd frontend && npx playwright test frontend/e2e/custom-emojis.spec.ts`
- [ ] Unit tests pass: `.venv/bin/pytest tests/test_custom_emojis.py`
