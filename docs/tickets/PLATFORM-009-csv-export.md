...
|---|--------------|-------------|
| 1 | `test_platform_009_create` | Create primary entity; 201 |
| 2 | `test_platform_009_read` | Read back entity; correct fields |
| 3 | `test_platform_009_update` | Update entity; 200; changes reflected |
| 4 | `test_platform_009_delete` | Delete entity; 200/204 |
| 5 | `test_platform_009_auth_required` | No auth; 401 |
| 6 | `test_platform_009_validation` | Invalid input; 422 |
...
**File**: `frontend/e2e/csv-export.spec.ts` -- 12 tests
...
**Independent** -- Read-only export; no schema changes.
...
- [ ] E2E pass: `npx playwright test e2e/csv-export.spec.ts`
