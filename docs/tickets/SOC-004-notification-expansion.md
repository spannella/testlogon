...
**File**: `tests/test_social_notifications.py`

| # | Test Function | Description |
|---|--------------|-------------|
| 1 | `test_soc_004_create` | Create primary entity; 201 |
| 2 | `test_soc_004_read` | Read back entity; correct fields |
| 3 | `test_soc_004_update` | Update entity; 200; changes reflected |
| 4 | `test_soc_004_delete` | Delete entity; 200/204 |
| 5 | `test_soc_004_auth_required` | No auth; 401 |
| 6 | `test_soc_004_validation` | Invalid input; 422 |
...
**File**: `frontend/e2e/social-notifications.spec.ts` -- 18 tests
...
| Ticket | Type | Detail |
|--------|------|--------|
| SOC-001 | Required | Follow events generate notifications |
| NOTIFY-001 | Required | Notification bell/SSE infrastructure |

### Depended On By

| Ticket | Type | Detail |
|--------|------|--------|
| PLATFORM-012 | Enables | Activity feed consumes expanded notification types |

### Merge Strategy

**Sequential** -- Requires SOC-001 and NOTIFY-001 merged for event sources and delivery infrastructure.
...
- [ ] E2E pass: `npx playwright test e2e/social-notifications.spec.ts`
