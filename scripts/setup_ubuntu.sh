...
echo "Next steps:"
echo "  1. Start the dev stack (first run downloads DynamoDB Local + Stripe mock):"
echo "       scripts/dev.sh start"
echo ""
echo "  2. Set up E2E test sessions (run after dev stack is up):"
echo "       python3 e2e_session_setup.py"
echo "       python3 e2e_admin_session_setup.py"
echo ""
