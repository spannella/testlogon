...
ALERT_EVENT_TYPES: List[str] = [
    ...
    "moderation_content_deleted","moderation_content_removed","moderation_content_hidden","moderation_content_reinstated","moderation_content_restored","moderation_violation_confirmed","moderation_hold_escalated","moderation_report_received","moderation_report_resolved","moderation_poster_responded","moderation_warning","moderation_ban","moderation_sla_breach","moderation_extortion_criminal_surge","dmca_claim_filed","dmca_content_restored","dmca_counter_notice_received","dmca_repeat_infringer_ban",    # DISP-050: payment-dispute events (default-on transactional push).
    "dispute_opened","dispute_filed_against","dispute_needs_response","dispute_creator_responded","dispute_response_reminder","dispute_resolved","dispute_resolved_against","dispute_resolved_favor","dispute_withdrawn","dispute_sla_expired","dispute_chargeback_opened","dispute_chargeback_evidence_due","dispute_chargeback_lost","dispute_chargeback_won",
]
