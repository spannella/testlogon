...
from app.routers.broadcast_ads import router as broadcast_ads_router
...
from app.routers.kyc_document_templates import router as kyc_document_templates_router
...
from app.routers.kyc_address_verification import kyc_address_verification_router
...
from app.routers.kyc_eidv import kyc_eidv_router
from app.routers.kyc_partner_api import kyc_partner_api_router
...
from app.routers.advertiser_api import advertiser_api_router
from app.routers.delegates import router as delegates_router
...
from app.routers.syndicate_feed import syndicate_feed_router
from app.routers.syndicate_advertising import syndicate_advertising_router
from app.routers.syndicate_open_licensing import syndicate_open_licensing_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(broadcast_ads_router)
    ...
    app.include_router(kyc_eidv_router)
    ...
    app.include_router(advertiser_api_router)
    ...
    app.include_router(syndicate_feed_router)
    app.include_router(syndicate_advertising_router)
    app.include_router(syndicate_open_licensing_router)
